    ...
    <div className='min-h-[550px] bg-gray-100'>
        ...
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2  gap-12'>
                ...
                <div className=''>
                <h1 className='texl-3xl font-bold sm:text-4xl '>Explore all corners fo the world with us</h1>
                <p className='text-sm text-gray-500 tracking-wide leading-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut fugit eaque assumenda. Itaque eligendi commodi modi repellendus neque porro exercitationem, autem doloremque voluptatum!</p>
